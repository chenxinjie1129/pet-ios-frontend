...
class MallViewModel {
    ...
    private func loadMockCategories() {
        let mockCategories = [
            ProductCategory(id: 1, name: "猫咪用品", parentId: 0, level: 1, sort: 1, icon: "cat", status: 1),
            ProductCategory(id: 2, name: "狗狗用品", parentId: 0, level: 1, sort: 2, icon: "dog", status: 1),
            ProductCategory(id: 3, name: "小宠用品", parentId: 0, level: 1, sort: 3, icon: "rabbit", status: 1),
            ProductCategory(id: 4, name: "猫粮", parentId: 1, level: 2, sort: 1, icon: nil, status: 1),
            ProductCategory(id: 5, name: "猫砂", parentId: 1, level: 2, sort: 2, icon: nil, status: 1),
            ProductCategory(id: 6, name: "猫玩具", parentId: 1, level: 2, sort: 3, icon: nil, status: 1),
            ProductCategory(id: 7, name: "狗粮", parentId: 2, level: 2, sort: 1, icon: nil, status: 1),
            ProductCategory(id: 8, name: "狗窝", parentId: 2, level: 2, sort: 2, icon: nil, status: 1),
            ProductCategory(id: 9, name: "狗玩具", parentId: 2, level: 2, sort: 3, icon: nil, status: 1)
        ]
